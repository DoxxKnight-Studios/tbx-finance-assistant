-- ============================================================
-- TBX Finance Assistant - Official Schema (MySQL)
-- ============================================================
--
-- MySQL schema for the official TBX data model
...
--
-- Translation notes:
--   - transaction is quoted with backticks because it is reserved-like.
-- ============================================================
...
-- Supports natural-language spend filters through MySQL FULLTEXT search.
